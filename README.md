...
## Install
- Double-click a `.terminal` file to import (for example `Wildcharm.terminal` or `Wildcharm-Pastel.terminal`), or run:
...
## Features
- ANSI palette tuned to the provided 16‑color scheme, with the standard and Pastel variants.
